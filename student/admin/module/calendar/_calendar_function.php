        ...
        <section class="clean-block clean-pricing dark">
            <div class="">
                <div class=""><div class="container"><div class="cssTable">
                    ...
                    <center>สถานะการลงทะเบียนแต่ล่ะปี <?php echo $row_addyear['year']; ?>
                        ...
                        <tr>
                          ...
                          //  echo "SELECT * FROM tb_student where status1 != '2' AND (year_start='$row_addyear[year]' AND year_end='$row_addyear[year]') ORDER BY id ASC";
                                ...
                                if($row_member['status1']==0){
                                  $status="<i class=\"fa fa-hourglass-2 text-warning\">รออนุมัติ</i>";}else if($row_member['status1']==1){$status="<i class=\"icon-user icon text-danger\">เต็ม</i>";}else{$status="ว่าง";
                                  }
                          	?>
                          	<?php
                          		$k=1;
