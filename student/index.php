<?php
 ...
 ?>
<?php
    $resule_pic=mysql_query("SELECT * FROM pic where pic_id and status1 = '1' ") or die(mysql_error());
    //$rows = mysql_fetch_array($resule_pic);
...
<body>
  ...
  <main class="page landing-page">
            <br><br>
            <?php
              while($rows = mysql_fetch_array($resule_pic)){
            ?>
            <div class="w3-content w3-display-container" style="max-width:100%;width:70%;">
              <img class="mySlidesa" src="uploads/picture_index/<?php echo $rows['pic_name'];?>" style="width:100%">
            <div class="w3-center w3-container w3-section w3-large w3-text-white w3-display-bottommiddle" style="width:100%">
                <div class="w3-left w3-hover-text-khaki" onclick="plusDivsa(-1)">&#10094;</div>
                <div class="w3-right w3-hover-text-khaki" onclick="plusDivsa(1)">&#10095;</div>
              </div>
            </div>
            ...
            ?>
              ...
              <hr />
                ...
                .w3-hover-text-khaki{color:red;background-color:#000000;width:5%;opacity: 0.2;filter: alpha(opacity=80);}
                </style>
                <script>
                    var slideIndexa = 1;
                    ...
                    function currentDiva(na) {
                      showDivsa(slideIndexa = na);
                    }

                    function showDivsa(na) {
                      var ia;
                      var xa = document.getElementsByClassName("mySlidesa");
                      var dotsa = document.getElementsByClassName("demoa");
                      if (na > xa.length) {slideIndexa = 1}
                      if (na < 1) {slideIndexa = xa.length}
                      for (ia = 0; ia < xa.length; ia++) {
                         xa[ia].style.display = "none";
                      }
                      for (ia = 0; ia < dotsa.length; ia++) {
                         dotsa[ia].className = dotsa[ia].className.replace(" w3-white", "");
                      }
                      xa[slideIndexa-1].style.display = "block";
                      dotsa[slideIndexa-1].className += " w3-white";
                    }
                </script>
                <!--<script>
                  var myIndex = 0;
                  ...
                  function carousel() {
                      ...
                      myIndex++;
                      if (myIndex > xa.length) {myIndex = 1}
                      xa[myIndex-1].style.display = "block";
